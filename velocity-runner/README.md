...
- den Validator 1.6.0 aus dem Maven-Build und die versionierte
...
Dabei nutzt der Runner automatisch die versionierte Konfiguration unter
`bundle-docs/xrechnung-3.0.2-validator-configuration-*.zip`, entpackt sie
nach `velocity-runner/target/validator-work/`, verwendet den per Maven
bereitgestellten KoSIT-Validator `1.6.0` aus
`velocity-runner/target/validator-bin/` und schreibt die Validator-Reports
